...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_template_directory_uri() . '/plugins/eventON_2.3.10.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => 'Pronto Theme Plugins', // The plugin name
            'slug'                  => 'pronto-theme-plugins', // The plugin slug (typically the folder name)
            'source'                => get_template_directory_uri() . '/plugins/pronto-theme-plugins.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
     ...
     */
    $config = array(
        'domain'            => 'bliccaThemes',           // Text domain - likely want to be the same as your theme.
        ...
        'strings'           => array(
            ...
            'installing'                                => __( 'Installing Plugin: %s', 'bliccaThemes' ), // %1$s = plugin name
            ...
            'complete'                                  => __( 'All plugins installed and activated successfully. %s', 'bliccaThemes' ) // %1$s = dashboard link
        )
    );

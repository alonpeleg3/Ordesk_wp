...
function encrypted_lite_widgets_init() {
    ...
    register_sidebar( array(
		...
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s '.encrypted_count_widgets('horizontal-sidebar-1').'">',
		'after_widget'  => '</aside>',
...
function encrypted_lite_scripts() {
    ...
    wp_enqueue_style( 'encrypted-lite-owl-carousel.css', get_template_directory_uri() . '/css/owl.carousel.css');
    
    wp_enqueue_style( 'encrypted-lite-owl-theme-default.css', get_template_directory_uri() . '/css/owl.theme.default.css');
	...
	wp_enqueue_script( 'encrypted-owl-carousel-js', get_template_directory_uri() . '/js/owl.carousel.js', array('jquery'), '20130115', true );
...
add_action( 'admin_init', 'encrypted_admin_script' );

    function encrypted_admin_script() {
        /* Register our script. */
        ...
        wp_enqueue_script( 'encrypted-admin', get_template_directory_uri() . '/js/encrypted-admin.js', array('jquery'), '20130115', true );
    }

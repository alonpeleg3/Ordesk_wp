...
<section class="call-to-action white-bg">
    <div class="el-container">
        ...
        ?>
            ...
            <div class="btn wow fadeIn animate cta-right" data-wow-delay="0.8s"><a class="read_more_text" href="<?php the_permalink() ?>"><?php echo esc_attr($encrypted_cta_read_more); ?></a>
            </div>  
...
<section class="feature-layout wow animated" data-wow-delay="0.5s">
    ...
    <div class="feature-layout-title"><span class="title_feature_post_section"><?php echo $encrypted_et_to['title_feature_post_section'] ?></span></div>
    </h2>
        ...
        <div class="three-layout">
            ...
            $encrypted_feature_page_id4 = $encrypted_et_to['select_post_feature_post_4'];
            $encrypted_feature_page_id5 = $encrypted_et_to['select_post_feature_post_5'];
            $encrypted_feature_page_id6 = $encrypted_et_to['select_post_feature_post_6'];
            ...
            foreach($encrypted_feature_pages as $encrypted_feature_page){
                ...
                while($encrypted_query_fp->have_posts()): $encrypted_query_fp->the_post();
                 $encrypted_count++;
            ?>
            <div data-wow-delay="0.5s" class="feature wow fadeIn animated feature<?php $encrypted_count ?>">
...
<section class="portfolio encrypted-section white-bg wow fadeIn animated" data-wow-delay="0.5s">
    ...
    <div class="feature-layout-title"><span class="portfolio_section_title"><?php echo $encrypted_et_to['portfolio_section_title'] ?></span></div>
    </h2>
        <div class="portfolio-desc portfolio_section_description"><?php echo $encrypted_et_to['portfolio_section_description'] ?></div>
        <div class="grid">
    <?php 
    ...
    $encrypted_port_args = array('cat'=>$encrypted_port_cat, 'post_type'=>'post', 'post_status'=>'publish', 'posts_per_page'=>9);
               ...
               <figure class="effect-sarah wow fadeIn animated" data-wow-delay="0.8s">
                ...
                <figcaption>
                    ...
                    <ul class="portfolio_tag">
                        ...
                        {
                            ?>
                            <li><a href="<?php echo site_url().'/category/'.$key->slug; ?>"><?php echo $key->cat_name; ?></a></li>
                            <?php
                        } ?>
                    </ul>
                    <div class="dtl_link"> 
...
<?php
if($encrypted_et_to['horizontal_sidebar_1_enable'] == 1)
{
 if(is_active_sidebar('horizontal-sidebar-1')):
    ...
    <section class="horizontal-sidebar1 hside-bar clearfix encrypted-section  wow fadeIn animated" data-wow-delay="0.5s">
        <div class="el-container">
            <h2>
                <div class="feature-layout-title"><span class="horizontal_sidebar_1_title"><?php echo $encrypted_et_to['horizontal_sidebar_1_title'] ?></span></div>
            </h2>
            <div class="portfolio-desc horizontal_sidebar_title_1_desc"><?php echo $encrypted_et_to['horizontal_sidebar_title_1_desc'] ?></div>
...
<section class="el-blog encrypted-section white-bg  wow fadeIn animated" data-wow-delay="0.5s">
    <div class="el-container">
        <h2 class="blog-main-title blog_section_title"><?php echo esc_attr($encrypted_et_to['blog_section_title']); ?></h2>
        <div class="blog-main-desc blog_section_description"><?php echo esc_attr($encrypted_et_to['blog_section_description']); ?></div>
        <div class="blog-wrap">
            <?php 
...
<section class="testimonial encrypted-section wow fadeIn animated" data-wow-delay="0.5s">
     <div class="el-container">
        <h2 class="testimonial-title testimonial_section_title"><?php echo esc_attr($encrypted_testimonials_title); ?></h2>
        <div class="testimonial-desc testimonial_section_description"><?php echo esc_attr($encrypted_testimonials_desc); ?></div>
...
<section class="team encrypted-section white-bg  wow fadeIn animated" data-wow-delay="0.5s">
    <div class="el-container">
        <h2 class="team_memeber_title team_member_section_title"><?php echo esc_attr($encrypted_team_title); ?></h2>
        <div class="team_member_desc team_member_section_description"><?php echo esc_attr($encrypted_team_desc);?></div>
...
<section class="client_logo encrypted-section white-bg wow fadeIn animated" data-wow-delay="0.8s">
    <div class="el-container">
        ...
        <div class="client_desc client_section_description"><?php echo esc_attr($encrypted_et_to['client_section_description']); ?></div>
...
?>
    ...
    <ul class="bottom_info_address">
        <div class="el-container">
        <li><i class="fa fa-map-marker"></i><p class="map_info_adderss"><?php echo esc_attr($encrypted_address) ?></p></li>
        <li><i class="fa fa-phone"></i><p class="map_info_phone"><?php echo esc_attr($encrypted_phone) ?></p></li>
        <li><i class="fa fa-envelope"></i><p class="map_info_email"><?php echo esc_attr($encrypted_email) ?></p></li>
        </div>
    </ul>   

...
/**
 * Encrypted lite widgets fields function
 * @package Encrypted lite
 * 
 */

function encrypted_letter_count($content, $limit) {
...
function encrypted_lite_widgets_updated_field_value($widget_field, $new_field_value) {

    extract($widget_field);

    // Allow only integers in number fields
    if ($encrypted_lite_widgets_field_type == 'number') {
        return absint($new_field_value);

        // Allow some tags in textareas
    } elseif ($encrypted_lite_widgets_field_type == 'textarea') {
        // Check if field array specifed allowed tags
        if (!isset($encrypted_lite_widgets_allowed_tags)) {
            // If not, fallback to default tags
            $encrypted_lite_widgets_allowed_tags = '<p><strong><em><a>';
        }
        return strip_tags($new_field_value, $encrypted_lite_widgets_allowed_tags);

        // No allowed tags for all other fields
    } elseif ($encrypted_lite_widgets_field_type == 'url') {
...
function encrypted_lite_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    // Store Posts in array
    $encrypted_lite_postlist[0] = array(
        'value' => 0,
        'label' => '--choose--'
    );
    $arg = array('posts_per_page' => -1);
    $encrypted_lite_posts = get_posts($arg);
    foreach ($encrypted_lite_posts as $encrypted_lite_post) :
        $encrypted_lite_postlist[$encrypted_lite_post->ID] = array(
            'value' => $encrypted_lite_post->ID,
            'label' => $encrypted_lite_post->post_title
        );
    endforeach;

    extract($widget_field);

    switch ($encrypted_lite_widgets_field_type) {

        // Standard text field
        case 'text' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>"><?php echo $encrypted_lite_widgets_title; ?>:</label>
                <input class="widefat" id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />

                <?php if (isset($encrypted_lite_widgets_description)) { ?>
                    <br />
                    <small><?php echo $encrypted_lite_widgets_description; ?></small>
                <?php } ?>
            </p>
            <?php
            break;
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>"><?php echo $encrypted_lite_widgets_title; ?>:</label>
                <textarea class="widefat" id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
            </p>
            <?php
            break;
        ...
        case 'checkbox' :
            ?>
            <p>
                <input id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>"><?php echo $encrypted_lite_widgets_title; ?></label>
        ...
        case 'radio' :
            ...
            <p>
                <?php
                echo $encrypted_lite_widgets_title;
                echo '<br />';
                foreach ($encrypted_lite_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        case 'select' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>"><?php echo $encrypted_lite_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" class="widefat">
                    <?php foreach ($encrypted_lite_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>"><?php echo $encrypted_lite_widgets_title; ?>:</label><br />
                <input name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
        ...
        case 'selectpost' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>"><?php echo $encrypted_lite_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" class="widefat">
                    <?php foreach ($encrypted_lite_postlist as $encrypted_lite_single_post) { ?>
                        <option value="<?php echo $encrypted_lite_single_post['value']; ?>" id="<?php echo $instance->get_field_id($encrypted_lite_single_post['label']); ?>" <?php selected($encrypted_lite_single_post['value'], $athm_field_value); ?>><?php echo $encrypted_lite_single_post['label']; ?></option>
                    <?php } ?>
                </select>
        ...
        case 'upload' :
            ...
            $output = '';
            $id = $instance->get_field_id($encrypted_lite_widgets_name);
            $class = '';
            $int = '';
            $value = $athm_field_value;
            $name = $instance->get_field_name($encrypted_lite_widgets_name);
            ...
            $output .= '<label for="'.$instance->get_field_id($encrypted_lite_widgets_name).'">'.$encrypted_lite_widgets_title.'</label><br/>';
            $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'encrypted-lite') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                if (( $value == '')) {
                    $output .= '<input id="upload-' . $id . '" class="upload-button-widget button" type="button" value="' . __('Upload', 'encrypted-lite') . '" />' . "\n";
                } else {
                    $output .= '<input id="remove-' . $id . '" class="remove-file-widget button" type="button" value="' . __('Remove', 'encrypted-lite') . '" />' . "\n";
                }
            } else {
                $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'encrypted-lite') . '</i></p>';
            }
            ...
            if ($value != '') {
                ...
                $attachment_id = encrypted_get_attachment_id_from_url($value);
                ...
                if ($image) {
                    ...
                    $title = __('View File', 'encrypted-lite');
        ...
        case 'icon' :
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($encrypted_lite_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($encrypted_lite_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
            ...
            <div id="encrypted-font-awesome-list">
                <ul class="encrypted-font-group">
                    ...
                    <li><i class="fa fa-mencrypted-marker"></i> </li>
 ...
 */
function encrypted_widget_media_scriptss($hook) {

    if (function_exists('wp_enqueue_media'))
        wp_enqueue_media();

    wp_register_script('of-media-uploader', get_template_directory_uri() . '/inc/path/js/media-uploader.js', array('jquery'), 1.70);
    wp_enqueue_script('of-media-uploader');
    wp_localize_script('of-media-uploader', 'encrypted_widget_l10n', array(
        'upload' => __('Upload', 'encrypted-lite'),
        'remove' => __('Remove', 'encrypted-lite')
    ));
}

add_action('admin_enqueue_scripts', 'encrypted_widget_media_scriptss');
